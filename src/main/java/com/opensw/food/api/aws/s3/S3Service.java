package com.opensw.food.api.aws.s3;
...
public class S3Service {
    ...
    public List<String> uploadArticleImages(String userIdentifier, List<MultipartFile> files) throws IOException {
        String dir = "article-images";
